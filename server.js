...
/* =========================================================
   SOCKET PLAYER VALIDATION
========================================================= */

function validPlayerForSocket(
    room,
    socket,
    playerId
) {
    ...
    socket => {
        ...
        socket.on(
            ...
            () => {
                ...
                /*
                    IMPORTANT:
                    Even 4 and 8 do NOT immediately
                    allow another roll.

                    The extra roll is granted only
                    AFTER the pawn has moved.
                */
